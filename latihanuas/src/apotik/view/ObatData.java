...
import apotik.model.ObatTableModel;

public class ObatData extends javax.swing.JDialog {
    private Connection connection;
    private ObatModel obatModel;
    private ObatTableModel obatTableModel;
    public ObatData(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        connection = DBConnection.newgetInstant();
        obatModel = new ObatModel(connection);
        obatTableModel = new ObatTableModel(new ArrayList<Obat>());
        tableRender();
    }

    private void tableRender(){
        tableData.setModel(obatTableModel);
    ...
    public Obat getSelectionRow(){
        int index = tableData.getSelectedRow();
        Obat barang = null;
        if(index >= 0){
            barang = obatTableModel.getRows().get(tableData.convertRowIndexToModel(index));
        }
        return barang;
    }
    ...
    private void buttonCariActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonCariActionPerformed
        obatTableModel.setRows(obatModel.search(textPencarian.getText()));
        obatTableModel.fireTableDataChanged();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ObatData.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ObatData dialog = new ObatData(new javax.swing.JFrame(), true);
