...
import apotik.model.PembeliTableModel;

public class PembeliData extends javax.swing.JDialog {

    private Connection connection;
    private PembeliModel pembeliModel;
    private PembeliTableModel pembeliTableModel;
    
    public PembeliData(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        
        connection = DBConnection.newgetInstant();
        pembeliModel = new PembeliModel(connection);
        pembeliTableModel = new PembeliTableModel(new ArrayList<Pembeli>());
        tableRender();
    }

    private void tableRender(){
        tableData.setModel(pembeliTableModel);
    ...
    public Pembeli getSelectionRow(){
        int index = tableData.getSelectedRow();
        Pembeli barang = null;
        if(index >= 0){
            barang = pembeliTableModel.getRows().get(tableData.convertRowIndexToModel(index));
        }
        return barang;
    }
    ...
    private void buttonCariActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonCariActionPerformed
        pembeliTableModel.setRows(pembeliModel.search(textPencarian.getText()));
        pembeliTableModel.fireTableDataChanged();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PembeliData.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                PembeliData dialog = new PembeliData(new javax.swing.JFrame(), true);
